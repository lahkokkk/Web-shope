document.addEventListener('DOMContentLoaded', () => {
    ...
    // Ganti API kamu di sini (gunakan Worker biar aman)
            ...
            const productCard = `
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden product-card flex flex-col">
                    ...
                    <div class="p-4 flex flex-col flex-grow">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mt-1 text-sm flex-grow">
                            ${(product.description || '').substring(0, 50)}...
                        </p>
                        <div class="mt-4 flex flex-wrap gap-2 items-center justify-between">
                            <span class="text-xl font-bold text-red-800 dark:text-red-500">
                                $${parseFloat(product.price || 0).toFixed(2)}
                            </span>
                            <button class="bg-red-800 text-white px-3 py-1.5 rounded-md hover:bg-red-900 text-sm w-full sm:w-auto">
                                Add to Cart
                            </button>
                        </div>
                    </div>
